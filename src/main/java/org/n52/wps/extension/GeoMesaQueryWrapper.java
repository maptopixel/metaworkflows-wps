 ...
 *
 */
public class GeoMesaQueryWrapper extends AbstractSelfDescribingAlgorithm {

	private static final Logger logger = LoggerFactory.getLogger(GeoMesaQueryWrapper.class);
					
	String wpsURL = "http://geoprocessing.westus.cloudapp.azure.com:8082/geoserver/ows?";
	String wpsProcessID = "geomesa:Query";
	
	private static final boolean useGeoNetworkFromWrapper = true;
	
	static final String INPUT = "features"; //was inputString
	static final String INPUT_ATTRIBUTE = "filter"; //was inputString
