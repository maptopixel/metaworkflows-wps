 ...
 *
 */
public class GeoServerHeatmapWrapper extends AbstractSelfDescribingAlgorithm {

	private static final Logger logger = LoggerFactory.getLogger(GeoServerHeatmapWrapper.class);
					
	String wpsURL = "http://geoprocessing.westus.cloudapp.azure.com:8082/geoserver/ows?";
	String wpsProcessID = "gs:Heatmap";
	
	private static final boolean useGeoNetworkFromWrapper = true;
	
	static final String INPUT = "data"; //was inputString
	static final String INPUT_ATTRIBUTE = "radiusPixels"; //was inputString
	static final String INPUT_ATTRIBUTE2 = "outputBBOX"; //was inputString
	static final String INPUT_ATTRIBUTE3 = "outputWidth"; //was inputString
	static final String INPUT_ATTRIBUTE4 = "outputHeight"; //was inputString
	...
	public Class<?> getInputDataType(String identifier) {
		...
		if (identifier.equals(INPUT_ATTRIBUTE2)) {
			return LiteralStringBinding.class;
		}
		if (identifier.equals(INPUT_ATTRIBUTE3)) {
			return LiteralStringBinding.class;
		}
		if (identifier.equals(INPUT_ATTRIBUTE4)) {
			return LiteralStringBinding.class;
		}
		return null;
	}	
	...
	public List<String> getInputIdentifiers() {
		...
		list.add( INPUT_ATTRIBUTE2);
		list.add( INPUT_ATTRIBUTE3);
		list.add( INPUT_ATTRIBUTE4);
		return list;
	}
